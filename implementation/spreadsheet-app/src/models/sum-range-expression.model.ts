...
export default class SumRangeExpression extends AbstractRangeExpression {
    ...
    // Get the raw value of the range denoted by "=SUM({First Cell}:{Last Cell})"
    public getRawValue(): string {
        ...
        return "SUM(" + position1 + ".." + position2 + ")";
    }
}